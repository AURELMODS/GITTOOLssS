...
echo ""
echo -e $cyan"    Create by           $white":" $red ahgaurel1  "
echo -e $cyan"    Github              $white":" $red https://github.com/ahgaurel1   "
echo -e $cyan ""
echo -e $okegreen"   ====================== Tool Lest =======================    ";
        ...
        case "$option" in 
           ...
           14)  echo "fluxion"
                ...
                clear
                ;;
            q)  echo -e $yellow " Thanks For Using My Tools Good Bye  {ahgaurel1}  !!"
                echo
                exit 0 
                ;;
        esac
